...
INSERT INTO bookings (transaction_id, equipment_id, renter_id, owner_id, start_datetime, end_datetime, total_price, status)
VALUES ('TXN-DEMO-LOCKED-001', 1, 2, 1, '2026-05-01 09:00:00', '2026-05-02 18:00:00', 1500.00, 'confirmed');
...
INSERT INTO bookings (transaction_id, equipment_id, renter_id, owner_id, start_datetime, end_datetime, total_price, status)
VALUES ('TXN-DEMO-ACTIVE-002', 2, 2, 1, '2026-04-10 09:00:00', '2026-04-12 18:00:00', 3000.00, 'active');
...
INSERT INTO bookings (transaction_id, equipment_id, renter_id, owner_id, start_datetime, end_datetime, total_price, status)
VALUES ('TXN-DEMO-COMPLETED-003', 1, 2, 1, '2026-03-01 09:00:00', '2026-03-01 18:00:00', 750.00, 'completed');
...
INSERT INTO bookings (transaction_id, equipment_id, renter_id, owner_id, start_datetime, end_datetime, total_price, status)
VALUES ('TXN-DEMO-MANUAL-004', 3, 2, 1, '2026-06-15 09:00:00', '2026-06-16 18:00:00', 2000.00, 'confirmed');
