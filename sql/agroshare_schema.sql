...
CREATE TABLE equipment (
    ...
    safety_deposit      DECIMAL(10,2)       NOT NULL DEFAULT 0.00,
...
CREATE TABLE bookings (
    ...
    status          ENUM('pending','confirmed','active','completed','cancelled','rejected','disputed') NOT NULL DEFAULT 'pending',
