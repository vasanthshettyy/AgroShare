<?php
/**
 * theme-toggle-btn.php — Reusable theme toggle button component.
 * Includes the button markup and SVG icons for Sun and Moon.
 */
?>
<button class="btn-icon theme-toggle-btn" id="themeToggleBtn" aria-label="Toggle Theme" title="Toggle Light/Dark Mode">
    <div class="theme-toggle-animated">
        <!-- Sun Icon -->
