...
try {
    ...
    $stmt = $conn->prepare("SELECT full_name, phone, email, village, district, state, profile_photo, trust_score, (password_hash IS NOT NULL) as has_password FROM users WHERE id = ?");
