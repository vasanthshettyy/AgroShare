...
<head>
    ...
    <meta name="description" content="Manage your equipment listing: <?= e($eq['title']) ?>.">
    ...
    <style>
        /* Specific styles for owner view */
        ...
        /* Make content wider since sidebar is gone */
        .product-layout-grid.owner-view {
...
<div class="app-layout">
    ...
    <header class="topbar" role="banner">
        <div class="topbar-left">
            ...
            <p class="topbar-greeting">Manage My Equipment</p>
        </div>
    ...
    <main class="main-content" role="main">
        ...
        <div class="product-header">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1.5rem; margin-top: 1rem;">
                <h1 style="margin:0; font-size: 1.75rem; color: var(--text-color);">Listing Management</h1>
                ...
                <div class="owner-header-actions">
                    <button class="btn-toggle-avail <?= $eq['is_available'] ? 'is-available' : 'is-unavailable' ?>"
                        ...
                        <span class="toggle-label"><?= $eq['is_available'] ? 'Active & Searchable' : 'Hidden from Search' ?></span>
                    </button>
                    ...
                    <form method="POST" action="my-equipment-detail.php?id=<?= $equipmentId ?>" class="inline-form"
        ...
        <div class="owner-management-panel" style="max-width: 900px; margin: 2rem auto;">
            <!-- Image Gallery -->
            <div class="product-image-frame" style="margin-bottom: 2rem;">
                <div class="detail-gallery">
                    <?php if (!empty($images)): ?>
                    <div class="gallery-main">
                        <img src="<?= e($images[0]) ?>" alt="<?= e($eq['title']) ?>" id="galleryMainImg" class="gallery-main-img" style="max-height: 400px; object-fit: contain; background: #000;">
                    </div>
            ...
            <div class="premium-section">
                <div style="display: flex; justify-content: space-between; align-items: baseline;">
                    <h2 class="product-title" style="margin:0;"><?= e($eq['title']) ?></h2>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 2rem; margin-top: 2rem;">
                    <div>
                        ...
                        <table class="specs-table" style="width: 100%;">
                            <tr><th>Condition</th><td><span class="condition-tag <?= e($eq['condition']) ?>"><?= e(ucfirst($eq['condition'])) ?></span></td></tr>
                            <tr><th>Operator</th><td><?= $eq['includes_operator'] ? 'Yes' : 'No' ?></td></tr>
                            <tr><th>Location</th><td><?= e($eq['location_village']) ?></td></tr>
                        </table>
                    </div>
                    <div>
                        <span class="section-label">Pricing</span>
                        <table class="specs-table" style="width: 100%;">
                            <tr><th>Daily</th><td>₹<?= number_format($eq['price_per_day'], 0) ?></td></tr>
                            <tr><th>Hourly</th><td>₹<?= number_format($eq['price_per_hour'], 0) ?></td></tr>
                        </table>
                    </div>
                </div>
            </div>
            ...
            <div class="premium-section" style="border-bottom: none;">
                <span class="section-label">Performance Statistics</span>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 1rem; margin-top: 1rem;">
                    <div style="background: var(--surface-color-alt); padding: 1rem; border-radius: 12px; text-align: center;">
                        <span style="display: block; font-size: 0.75rem; color: var(--text-muted); margin-bottom: 0.5rem;">Views</span>
                        <strong style="font-size: 1.25rem;">--</strong>
                    </div>
                    <div style="background: var(--surface-color-alt); padding: 1rem; border-radius: 12px; text-align: center;">
                        <span style="display: block; font-size: 0.75rem; color: var(--text-muted); margin-bottom: 0.5rem;">Bookings</span>
                        <strong style="font-size: 1.25rem;">--</strong>
                    </div>
                    <div style="background: var(--surface-color-alt); padding: 1rem; border-radius: 12px; text-align: center;">
                        <span style="display: block; font-size: 0.75rem; color: var(--text-muted); margin-bottom: 0.5rem;">Revenue</span>
                        <strong style="font-size: 1.25rem;">₹0</strong>
                    </div>
                </div>
            </div>
        </div>
